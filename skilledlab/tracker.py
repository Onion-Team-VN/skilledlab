...
from skilledlab.internal.tracker import tracker_singleton as _internal
from skilledlab.internal.tracker_debug import tracker_debug_singleton as _tracker_debug_singleton
...
def add(*args, **kwargs):
    ...
    These will be saved when :func:`skilledlab.tracker.save` is called.

    You should use :func:`skilledlab.tracker.add` to improve performance since
